...
public:
    ...
    TcpPollServerTransport(const SlipstreamConfig& config, MarketEventQueue& in, OrderEntryQueue& out,
...
private:
    ...
    void recvMarketEvent(utils::Socket<utils::SockType::Tcp>& client, codec::MarketEventDecoder& decoder,
